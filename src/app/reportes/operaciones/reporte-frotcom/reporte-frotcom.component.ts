...
@Component({
  selector: 'app-reporte-frotcom',
  templateUrl: './reporte-frotcom.component.html',
  styleUrls: ['./reporte-frotcom.component.css']
})
export class ReporteFrotcomComponent implements OnInit {
