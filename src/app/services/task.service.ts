...
export class TaskService {
  ...
  resumenOpenIA(textoDelReporte: string){
    ...
    return this.http.post("https://api.openai.com/v1/chat/completions", {
      model: "gpt-4o-mini",
      messages: [
        { role: "system", content: "Eres un analista experto en reportería de ventas de boletos y postergaciones. "+
          ...
          " - Indica si hubo cambios de importe, asientos o fechas entre los movimientos. "+
